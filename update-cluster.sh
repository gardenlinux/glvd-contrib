...
podman pull --arch=amd64 ghcr.io/gardenlinux/glvd-postgres:edgefulldata
...
podman pull --arch=amd64 ghcr.io/gardenlinux/glvd-api:edge
...
podman pull --arch=arm64 ghcr.io/gardenlinux/glvd-postgres:edgefulldata
podman pull --arch=arm64 ghcr.io/gardenlinux/glvd-api:edge
